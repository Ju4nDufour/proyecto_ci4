...
<head>
    ...
    <title><?= esc($title ?? 'Instituto Superior N┬░ 57 - Chascom├║s') ?></title>
    <meta name="description" content="Instituto Superior de Formaci├│n Docente y T├®cnica N┬░ 57 - Chascom├║s, Buenos Aires">
    ...
    <div class="container">
        <a class="navbar-brand d-flex align-items-center gap-2" href="<?= site_url('/') ?>">
            ...
            <div>
                ...
                <div style="font-size: 0.75rem; opacity: 0.9; font-weight: 400;">Chascomus, Buenos Aires</div>
            </div>
        </a>
                    ...
                    <?php if ($user->inGroup('admin')): ?>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><a class="dropdown-item" href="<?= site_url('carreras/admin') ?>"><i class="bi bi-journal-bookmark"></i> Carreras</a></li>
...
<footer>
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-md-4 footer-section">
                ...
                <p class="text-white-50">
                    Formacion docente y teccnica de excelencia desde 1958.
            ...
            <!-- Columna 2: Enlaces r├ípidos -->
            <div class="col-md-4 footer-section">
                <h5><i class="bi bi-link-45deg me-2"></i>Enlaces Rapidos</h5>
            ...
            <div class="col-md-4 footer-section">
                ...
                <p class="text-white-50 mb-2">
                    ...
                    <span class="ms-4">Chascomus, Buenos Aires</span>
                </p>
                <p class="text-white-50 mb-2">
        ...
        <div class="text-center text-white-50">
            <small>
                &copy; <?= date('Y') ?> Instituto Superior N° 57 - Chascomus.

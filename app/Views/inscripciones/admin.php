    ...
    <div class="card shadow-sm border-0 h-100">
      ...
      <div class="card-body">
        <table class="table table-sm table-striped align-middle">
          <thead>
            <tr><th>Alumno</th><th>Curso</th><th>Carrera</th><th>Modalidad</th><th>Turno</th><th></th></tr>
          </thead>
          <tbody>
            ...
            <tr>
              ...
              <td class="text-end">
                <form method="post" action="<?= site_url('inscripciones/delete/'.$a['id_alumno_curso']) ?>"
                  ...
                  <button class="btn btn-sm btn-outline-danger" aria-label="Eliminar inscripcion" title="Eliminar">
  ...
  <div class="col-md-6">
    <div class="card shadow-sm border-0 h-100">
      ...
      <div class="card-body">
        <table class="table table-sm table-striped align-middle">
          <thead>
            <tr><th>Profesor</th><th>Curso</th><th>Carrera</th><th>Fecha</th><th></th></tr>
          </thead>
          <tbody>
            ...
            <tr>
              ...
              <td class="text-end">
                <form method="post" action="<?= site_url('inscripciones/delete/'.$p['id_profesor_curso']) ?>"
                  ...
                  <button class="btn btn-sm btn-outline-danger" aria-label="Eliminar asignacion" title="Eliminar">
                    <i class="bi bi-trash"></i><span class="visually-hidden">Eliminar</span>
                  </button>
                </form>
              </td>

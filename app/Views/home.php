...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <!-- Estadísticas -->
            <div class="row row-cols-2 g-3 mt-4 mb-4">
                <div class="col">
                    <div class="card text-center shadow-sm">
                        <div class="card-body">
                            <h5 class="card-title text-primary">👨‍🎓 Alumnos</h5>
                            <h2 class="text-primary fw-bold"><?= $alumnosCount ?? 0 ?></h2>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card text-center shadow-sm">
                        <div class="card-body">
                            <h5 class="card-title text-success">🎓 Carreras</h5>
                            <h2 class="text-success fw-bold"><?= $carrerasCount ?? 0 ?></h2>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card text-center shadow-sm">
                        <div class="card-body">
                            <h5 class="card-title text-info">📚 Cursos</h5>
                            <h2 class="text-info fw-bold"><?= $cursosCount ?? 0 ?></h2>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card text-center shadow-sm">
                        <div class="card-body">
                            <h5 class="card-title text-warning">🧑‍🏫 Profesores</h5>
                            <h2 class="text-warning fw-bold"><?= $profesoresCount ?? 0 ?></h2>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card text-center shadow-sm">
                        <div class="card-body">
                            <h5 class="card-title text-danger">📝 Inscripciones</h5>
                            <h2 class="text-danger fw-bold"><?= $inscripcionesCount ?? 0 ?></h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row row-cols-2 g-3">
                ...
                <div class="col">
                    <a href="<?= site_url('inscripciones') ?>" class="btn btn-outline-primary w-100">
                        📝 Ver Inscripciones
                    </a>
                </div>
            </div>
